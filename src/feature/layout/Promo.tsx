...
const handleClick = () => {
  ...
  const src = "/assets/images/Bahan Website/Promo Paket Kemitraan/Paket Kemitraan Chicago.mp4";
  ...
  return (
    <Dialog  defaultOpen >
      <DialogContent 
        ...
        showCloseButton="outside"  
        className="max-h-[100dvh] w-full lg:max-h-[44rem] justify-between border-0 h-fit max-w-[90dvw]  lg:max-w-[1180px] overflow-hidden  flex flex-col lg:gap-4  gap-5 items-center lg:items-end  lg:pt-0  lg:pb-5 px-0 shadow-none rounded-none bg-[223] ease-out duration-300  "
      >
        ...
        <MediaItem 
          item={itemFile} 
          className=' lg:max-h-none lg:border-r-8 border-yellow-300 lg:rounded-none max-h-[60em] rounded-lg h-full' 
        />
        ...
        <div className='w-full content-center lg:px-24 justify-center lg:gap-y-8 flex flex-col lg:h-full h-fit gap-y-6.5  lg:gap-15'>
          <article className="space-y-1.5 lg:space-y-6">
            <DialogHeader className='gap-1.5 lg:gap-4'>
              ...
              <DialogTitle style={{}} className="text-left text-[4.5dvh] leading-10 lg:text-[3.7rem] lg:leading-13 font-extrabold  tracking-tighter lg:tracking-tight lg:uppercase  "> 
...
lg:bg-clip-text
lg:text-transparent
 lg:drop-shadow-[-4px_4px_0px_rgba(0,0,0,8)]"  > Cash Back </span>
                 <span className="   lg:bg-gradient-to-t
from-red-700

to-red-400
lg:bg-clip-text
lg:text-transparent lg:block l lg:drop-shadow-[-4px_4px_0px_rgba(0,0,0,8)]">Langsung </span>
              </DialogTitle>
            </DialogHeader>
            <p className=' lg:font-semibold tracking-tight lg:text-lg text-[2.3svh] '>
