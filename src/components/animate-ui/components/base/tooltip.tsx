  ...
  return (
    <TooltipPortalPrimitive>
      ...
      >
        ...
        >
          {children}
          <TooltipArrowPrimitive className="bg-neutral-900 fill-primary z-50 size-2.5 data-[side='bottom']:-top-[4px] data-[side='right']:-left-[4px] data-[side='left']:-right-[4px] data-[side='inline-start']:-right-[4px] data-[side='inline-end']:-left-[4px] rotate-45 rounded-[2px] dark:bg-neutral-50" />
        </TooltipPopupPrimitive>
      </TooltipPositionerPrimitive>
    </TooltipPortalPrimitive>
  );
